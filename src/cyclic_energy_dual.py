...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate the capacity-free cyclic upper value for a reconstructed activation cache.')
    ...
    report = bound(activation, args.supply_mw, args.eta, args.reserve_mw, args.amplitude)
    report.update(eta=args.eta, amplitude=args.amplitude, supply_mw=args.supply_mw, no_reserve_mwh=len(activation) / 3600.0 * args.supply_mw)
