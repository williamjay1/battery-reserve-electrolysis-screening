...
before this script was run. Use --input-root and --witness to reconstruct from
authorized inputs. This analysis never solves a new optimization problem.
"""
...
def main():
    ...
    quarter_path = args.input_root/'reference_quarter_solution.npz'
    try:
