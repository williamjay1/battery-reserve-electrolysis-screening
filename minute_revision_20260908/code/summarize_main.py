...
d=pd.read_csv(ROOT/'results'/'germany_main_daily.csv.gz')
...
g.to_csv(ROOT/'results'/'germany_main_summary.csv',index=False)
decisions=[]
...
pd.DataFrame(decisions).to_csv(ROOT/'results'/'germany_capacity_decisions.csv',index=False)
...
pd.DataFrame(cis).to_csv(ROOT/'results'/'germany_paired_uncertainty.csv',index=False)
